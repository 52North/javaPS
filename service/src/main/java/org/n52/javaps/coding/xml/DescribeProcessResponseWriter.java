 ...
 *
 */
public class DescribeProcessResponseWriter extends AbstractXmlStreamWriter<ProcessDescription> {
    ...
    @Override
    protected void write(ProcessDescription processDescription) throws XMLStreamException {
        ...
        for (InputDescriptor<?> inputDescriptor : algorithmDescriptor.getInputDescriptors()) {
            ...
            if (inputDescriptor instanceof LiteralDataInputDescriptor) {
                ...
                if (literalDescriptor.hasAllowedValues()) {
                    ...
                    //TODO Range? UOM? have to be added to AnnotatedAlgorithm classes
        ...
        for (OutputDescriptor<?> outputDescriptor : algorithmDescriptor.getOutputDescriptors()) {
            ...
            if (outputDescriptor instanceof LiteralDataOutputDescriptor) {
                ...
                // TODO need something like this: describeComplexDataOutputType200(complexDataType, outputDescriptor.getBinding()
