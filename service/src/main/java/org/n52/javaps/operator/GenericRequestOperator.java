...
import org.n52.javaps.handler.GenericHandler;
...
public class GenericRequestOperator<
    ...
    protected GenericHandler<Q, A> getOperationHandler() {
    ...
    protected Optional<GenericHandler<Q, A>> getOptionalOperationHandler() {
    ...
    protected Optional<GenericHandler<Q, A>> getOptionalOperationHandler(
        ...
        return Optional.ofNullable(this.operationHandlerRepository
                ...
                .map(x -> (GenericHandler<Q, A>) x);
    }

    @Override
    public OwsOperation getOperationMetadata(String service, String version)
            throws OwsExceptionReport {
        Optional<GenericHandler<Q, A>> optionalOperationHandler
