 ...
 */
package org.n52.iceland.ogc.wps.description;
...
public interface LiteralDataDomain {
    ...
    interface Builder<T extends LiteralDataDomain, B extends Builder<T, B>>
            extends org.n52.javaps.utils.Builder<T, B> {
