 ...
 * @author tkunicki
 */
public abstract class InputDescription<T extends Class<? extends IData>> extends BoundDescription<T> {

    private final BigInteger minOccurs;

    private final BigInteger maxOccurs;

    protected InputDescription(Builder<? extends Builder<?, T>, T> builder) {
        super(builder);
    ...
    public static abstract class Builder<B extends Builder<B, T>, T extends Class<? extends IData>> extends BoundDescription.Builder<B, T> {
        ...
        public abstract InputDescription<T> build();
    }
}
