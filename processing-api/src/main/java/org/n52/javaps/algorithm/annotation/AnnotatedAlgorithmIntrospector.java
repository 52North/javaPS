...
import org.n52.javaps.algorithm.annotation.AnnotationParser.ComplexDataInputFieldAnnotationParser;
import org.n52.javaps.algorithm.annotation.AnnotationParser.ComplexDataInputMethodAnnotationParser;
import org.n52.javaps.algorithm.annotation.AnnotationParser.ComplexDataOutputFieldAnnotationParser;
import org.n52.javaps.algorithm.annotation.AnnotationParser.ComplexDataOutputMethodAnnotationParser;
import org.n52.javaps.algorithm.annotation.AnnotationParser.ExecuteAnnotationParser;
import org.n52.javaps.algorithm.annotation.AnnotationParser.InputAnnotationParser;
import org.n52.javaps.algorithm.annotation.AnnotationParser.LiteralDataInputFieldAnnotationParser;
import org.n52.javaps.algorithm.annotation.AnnotationParser.LiteralDataInputMethodAnnotationParser;
import org.n52.javaps.algorithm.annotation.AnnotationParser.LiteralDataOutputFieldAnnotationParser;
import org.n52.javaps.algorithm.annotation.AnnotationParser.LiteralDataOutputMethodAnnotationParser;
import org.n52.javaps.algorithm.annotation.AnnotationParser.OutputAnnotationParser;
...
public class AnnotatedAlgorithmIntrospector {
    ...
    static {
        List<InputAnnotationParser<?, Field, ?>> inputFieldParsers = new ArrayList<InputAnnotationParser<?, Field, ?>>();
        ...
        List<InputAnnotationParser<?, Method, ?>> inputMethodParsers = new ArrayList<InputAnnotationParser<?, Method, ?>>();
        ...
        List<OutputAnnotationParser<?, Field, ?>> outputFieldParsers = new ArrayList<OutputAnnotationParser<?, Field, ?>>();
        ...
        List<OutputAnnotationParser<?, Method, ?>> outputMethodParsers = new ArrayList<OutputAnnotationParser<?, Method, ?>>();
    ...
    private final static Map<Class<?>, AnnotatedAlgorithmIntrospector> INTROSPECTOR_MAP = new HashMap<Class<?>, AnnotatedAlgorithmIntrospector>();
    ...
    private void parseClass() {
        ...
        algorithmBuilder = AlgorithmDescriptor.builder(algorithm.identifier().length() > 0 ? algorithm.identifier() : algorithmClass.getCanonicalName());
