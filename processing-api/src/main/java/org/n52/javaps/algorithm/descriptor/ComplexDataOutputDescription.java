 ...
 * @author tkunicki
 */
public class ComplexDataOutputDescription<T extends Class<? extends IComplexData>> extends OutputDescription<T> {

    private ComplexDataOutputDescription(Builder builder) {
        super(builder);
    }
    ...
    public static abstract class Builder<B extends Builder<B, T>, T extends Class<? extends IComplexData>> extends OutputDescription.Builder<B, T> {

        private Builder(String identifier, T binding) {
            super(identifier, binding);
        }

        public ComplexDataOutputDescription<T> build() {
            return new ComplexDataOutputDescription<T>(this);
        }
    }
}
