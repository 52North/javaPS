 ...
 * @author tkunicki
 */
public class LiteralDataOutputDescription<T extends Class<? extends ILiteralData>> extends OutputDescription<T> {

    private final String dataType;

    protected LiteralDataOutputDescription(Builder builder) {
        super(builder);
    ...
    public static abstract class Builder<B extends Builder<B, T>, T extends Class<? extends ILiteralData>> extends OutputDescription.Builder<B, T> {
        ...
        @Override
        public LiteralDataOutputDescription<T> build() {
            return new LiteralDataOutputDescription<T>(this);
        }
    }
}
