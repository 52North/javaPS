 ...
 * @author tkunicki
 */
public class ComplexDataInputDescription<T extends Class<? extends IComplexData>> extends InputDescription<T> {

    private final BigInteger maximumMegaBytes;

    private ComplexDataInputDescription(Builder builder) {
        super(builder);
    ...
    public static abstract class Builder<B extends Builder<B, T>, T extends Class<? extends IComplexData>> extends InputDescription.Builder<B, T> {
        ...
        @Override
        public ComplexDataInputDescription<T> build() {
            return new ComplexDataInputDescription<T>(this);
        }
    }
}
