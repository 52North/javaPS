 ...
 * @author tkunicki
 */
public class LiteralDataInputDescription<T extends Class<? extends ILiteralData>> extends InputDescription<T> {
    ...
    protected LiteralDataInputDescription(Builder builder) {
        super(builder);
        ...
        Preconditions.checkState(!hasAllowedValues() || !hasDefaultValue() || allowedValues.contains(defaultValue), "defaultValue of %s not in set of allowedValues", defaultValue);
    }
    ...
    public static abstract class Builder<B extends Builder<B, T>, T extends Class<? extends ILiteralData>> extends InputDescription.Builder<B, T> {
        ...
        @Override
        public LiteralDataInputDescription<T> build() {
            return new LiteralDataInputDescription<T>(this);
        }
    }
}
