...
public class GroupInputDescriptionImpl extends AbstractProcessInputDescription
    ...
    public static GroupInputDescription.Builder<?, ?> builder() {
        return new BuilderImpl();
    }

    protected static abstract class AbstractBuilder<T extends GroupInputDescription, B extends AbstractBuilder<T, B>>
    ...
    private static class BuilderImpl extends AbstractBuilder<GroupInputDescriptionImpl, BuilderImpl> {
        @Override
