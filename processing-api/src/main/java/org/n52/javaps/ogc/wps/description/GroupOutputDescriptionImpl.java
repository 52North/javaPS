...
public class GroupOutputDescriptionImpl extends AbstractProcessOutputDescription
    ...
    public GroupOutputDescriptionImpl(OwsCode id,
        ...
        Set<ProcessOutputDescription> i = outputs == null ? Collections
                .emptySet() : outputs;
        this.outputs = i.stream()
    ...
    public static GroupOutputDescription.Builder<?, ?> builder() {
        return new BuilderImpl();
    }

    protected static abstract class AbstractBuilder<T extends GroupOutputDescription, B extends AbstractBuilder<T, B>>
    ...
    private static class BuilderImpl extends AbstractBuilder<GroupOutputDescriptionImpl, BuilderImpl> {
        @Override
