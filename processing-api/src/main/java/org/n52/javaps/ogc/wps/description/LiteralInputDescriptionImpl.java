...
public class LiteralInputDescriptionImpl
    ...
    public static LiteralInputDescription.Builder<?, ?> builder() {
        return new BuilderImpl();
    }

    protected static abstract class AbstractBuilder<T extends LiteralInputDescription, B extends LiteralInputDescription.Builder<T, B>>
    ...
    private static class BuilderImpl extends AbstractBuilder<LiteralInputDescriptionImpl, BuilderImpl> {
        @Override
