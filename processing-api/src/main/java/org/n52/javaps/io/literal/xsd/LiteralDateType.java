...
public class LiteralDateType extends AbstractXSDLiteralType<LocalDate> {
    ...
    @Override
    public LocalDate parse(OwsCode name, String value) throws OwsExceptionReport {
        try {
    ...
    @Override
    public String generate(OwsCode name, LocalDate value) throws OwsExceptionReport {
