...
public interface ProcessesApi {
    ...
    @PostMapping(value = BASE_URL + "/processes/{id}/jobs", produces = {MediaTypes.APPLICATION_JSON},
    ...
    @GetMapping(value = BASE_URL + "/processes/{processId}/jobs", produces = {MediaTypes.APPLICATION_JSON})
    ResponseEntity<?> getJobList(@PathVariable("processId") String processId);

    @GetMapping(value = BASE_URL + "/processes/{processId}/jobs", produces = {MediaTypes.TEXT_HTML})
    ...
    @GetMapping(value = BASE_URL + "/processes/{processId}/jobs/{jobId}/result",
                produces = {MediaTypes.APPLICATION_JSON})
    ResponseEntity<?> getResult(@PathVariable("processId") String id, @PathVariable("jobId") String jobId)
            throws EngineException;

    @GetMapping(value = BASE_URL + "/processes/{processId}/jobs/{jobId}", produces = {MediaTypes.APPLICATION_JSON})
    @ResponseBody
