...
public class GetResultKvpIT extends Base {
    ...
    public void resultNotReady() throws ParserConfigurationException, SAXException, IOException, XmlException {
        ...
        URL resource = getClass().getClassLoader().getResource("requests/Execute/EchoProcessDuration5000.xml");
        ...
        GetClient.checkForExceptionReport(url, "Service=WPS&Request=GetResult&version=2.0.0&jobID=" + jobId, HttpServletResponse.SC_BAD_REQUEST, "ResultNotReady", jobId);
